...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (res == null) System.out.println("Test 10 failed1");
			...
			System.out.println("Test 10 failed2");
		}
		catch (Exception e) {
			System.out.println(e.getMessage());
			System.out.println("Test 10 failed3");
		}
		...
		try {
			tree.remove(tree.getRoot(),p);
			System.out.println(tree.get(tree.getRoot(),p)==null);
			res = tree.successor(tree.getRoot(),new Location(39,19));
          
			if (res.getLocation().compareTo(new Location(39,20)) != 0)
				System.out.println("Test 16 failed1");
			else {
			    res = tree.get(tree.getRoot(),new Location(39,4));
			    System.out.println("test");
			    if (res == null) System.out.println("Test 16 failed2");
			    System.out.println("Test 16 passed");
			}
		}
		catch (Exception e) {
			System.out.println("Test 16 failed3");
		}
